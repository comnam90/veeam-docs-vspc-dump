...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/flr_perform_restore_win.html"
...
1. In the file-level restore portal, open the Restore List tab.
...
In the Download Files window, specify credentials of a local administrator account on the computer hosting Veeam Agent for Microsoft Windows and click Verify.
...
1. If you want to restore other objects using different restore action, repeat steps 2–3 for all the objects you want to restore.

If you do not want to restore an object, click Remove from Restore List to remove selected object from the list.

[![Perform Restore](images/flr_restore_list_win.webp)](images/flr_restore_list_win.webp "Perform Restore")
