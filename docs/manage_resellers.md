...
* Managing Veeam Backup & Replication servers and jobs for a client company.
* Managing Veeam Backup for Microsoft 365 jobs and Veeam Backup for Public Clouds policies for a client company.
