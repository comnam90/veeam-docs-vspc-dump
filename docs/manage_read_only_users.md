---
title: "Managing Read-Only Users"
product: "vspc"
doc_type: "provider_admin"
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/manage_read_only_users.html"
...
1. At the Role step of the wizard, select the Read-only User role.
...
2. In the configuration menu on the left, click Roles & Users.
3. Open the My Company tab and navigate to Windows Users.
4. At the top of the page, select the Read-only User role.
