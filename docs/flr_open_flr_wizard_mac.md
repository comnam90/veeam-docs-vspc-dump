...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/flr_open_flr_wizard_mac.html"
...
To display all macOS agents, click Filter, in the Guest OS section select macOS and click Apply.
