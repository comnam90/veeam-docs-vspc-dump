...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_user/configure_ad_discovery.html"
...
* Deploy a master agent on a machine in the company infrastructure. The machine must be included in a domain within which computers will be discovered.
...
2. In the Locations window, click an organizational unit link for the necessary company location.
