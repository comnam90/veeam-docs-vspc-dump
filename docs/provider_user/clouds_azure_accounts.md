...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_user/clouds_azure_accounts.html"
...
* For Veeam Backup for Microsoft Azure version 7 or later — [create accounts in Veeam Backup for Microsoft Azure web portal](#azure).
* For Veeam Backup for Microsoft Azure older than version 7 — [create accounts in Veeam Service Provider Console plugin](#vspc) or [connect an existing service account](#exist_azure).
...
You can create Microsoft Azure connection accounts in Veeam Backup for Microsoft Azure web portal:
...
You will be redirected to Veeam Backup for Microsoft Azure web portal.

1. Create account in Veeam Backup for Microsoft Azure.

For details, see section [Adding Service Accounts](https://helpcenter.veeam.com/docs/vbazure/guide/service_account_add.html) of the Veeam Backup for Microsoft Azure User Guide.

Creating Microsoft Azure Account in Veeam Service Provider Console

You can create new Microsoft Azure connection accounts in Veeam Service Provider Console plugin:
...
* In the Appliance field, select Veeam Backup for Microsoft Azure appliance for which you want to create the account.
...
A Microsoft Azure authentication window will open.

1. On the Microsoft Azure device authentication page, paste the code that you have copied and sign in to Microsoft Azure.

Make sure to sign in with the user account that has the User Access Administrator or the Owner role. For details on account roles, see [Microsoft Docs](https://docs.microsoft.com/en-us/azure/active-directory/users-groups-roles/directory-assign-admin-roles).
...
1. In the Appliance field, select Veeam Backup for Microsoft Azure appliance for which you want to create the account.
