...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_user/vbr_ha_clusters.html"
...
* The secondary node of a cluster is displayed only on the Backup Servers tab.
...
For details on connecting the primary node of a High Availability cluster, see [Connecting Veeam Backup & Replication Servers](connect_backup_servers.md#client).
