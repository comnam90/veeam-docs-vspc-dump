...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_user/plugins.html"
...
If you want to manage Veeam Backup for Microsoft 365 servers, you must deploy Veeam Service Provider Console management agents on these servers. For details, see [Deploying Veeam Service Provider Console Management Agents](install_management_agents.md).
