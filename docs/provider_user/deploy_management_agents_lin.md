...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_user/deploy_management_agents_lin.html"
...
If you have downloaded the management agent setup file from Veeam Service Provider Console, it will connect to Veeam Service Provider Console automatically. Otherwise, you must configure the agent manually.
