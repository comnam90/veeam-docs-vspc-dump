...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_user/export_failover_plans.html"
...
* Location — limit the list of failover plans by location to which failover plans belong. To limit the list of failover plans by location, use filter at the top left corner of the Veeam Service Provider Console window.
