---
title: "Step 12. Specify Cloud Backup Settings"
product: "vspc"
doc_type: "provider_user"
source_url: "https://helpcenter.veeam.com/docs/vac/provider_user/specify_cloud_backup_settings_lin.html"
last_updated: "5/4/2026"
product_version: "9.2.0.33215"
---

# Step 12. Specify Cloud Backup Settings


The Cloud Repository step of the wizard is available if at the [Destination](choose_backup_destination_lin.md) step you have chosen to save backup files on a Veeam Cloud Connect repository.
...
| --- |
| Note: |
| The policy will target to the default repository specified by your service provider. If you want to store backups on another backup repository, you can choose this repository in backup job settings for specific computers. For details, see [Configuring Backup Job Settings for Individual Computers](change_backup_job_settings.md). |

[![Specify Cloud Repository Settings](images/job_template_cloud_repository_lin.webp)](images/job_template_cloud_repository_lin.webp "Specify Cloud Repository Settings")
