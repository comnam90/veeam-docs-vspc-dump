...
| --- |
| Important! |
| To configure API Keys, you must have access to Veeam Service Provider Console REST API. To get access to REST API, contact your service provider.  Note that after your service provider disables access to Veeam Service Provider Console REST API for your company, all API keys will be disabled automatically. |
...
1. If you want to enable read-only access to the API key, set the Read-only access toggle to On.
...
* [Enabling and Disabling API Keys](enable_disable_api_key.md)
