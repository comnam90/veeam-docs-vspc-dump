...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_user/clouds_database_accounts.html"
...
* From the Appliance drop-down list, select Veeam Backup for Public Clouds appliance on which you want to register the account.
