...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_user/export_protected_object_storage_data.html"
...
* Location — limit the list of object storage by location to which object storage belong. To limit the list of object storage by location, use filter at the top left corner of the Veeam Service Provider Console window.
