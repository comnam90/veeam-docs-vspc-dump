...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_user/sso.html"
...
You can configure SSO authentication for the Client Portal users. To do that, you must perform the following operations:
