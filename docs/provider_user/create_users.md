...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_user/create_users.html"
...
You can create new users with the Location User role.
...
1. At the Role step of the wizard, in the Role field, choose Location User.
