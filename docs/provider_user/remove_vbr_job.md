...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_user/remove_vbr_job.html"
...
4. From the Configuration drop-down list, select Delete.

Alternatively, you can right-click the necessary job and choose Configuration > Delete.
