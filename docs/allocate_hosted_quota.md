...
To limit the actions that the company can perform with jobs on hosted Microsoft 365 servers, click a link in the Backup jobs permissions field and configure the necessary permissions (Create, Edit, Delete, Enable/Disable, Start/Stop, Manage Job Settings).
