...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/get_latest_configuration.html"
...
4. In the Agent Backup Job window, click Filter. In the Filter agents backup jobs by assigned policy section, select the Outdated check box only. Click Apply.
