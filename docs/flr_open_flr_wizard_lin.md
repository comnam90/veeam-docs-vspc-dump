...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/flr_open_flr_wizard_lin.html"
...
To display all Linux agents, click Filter, in the Guest OS section select Linux and click Apply.

1. At the top of the list, click File-Level Restore Portal.

Alternatively, you can right-click the necessary agent and choose File-Level Restore Portal.
