...
For Linux Veeam Backup & Replication servers (Veeam Software Appliance), you can only [upload private fixes](#vsa_fix).
...
To upload a private fix to a Linux Veeam Backup & Replication server:
