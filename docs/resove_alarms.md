...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/resove_alarms.html"
...
[For alarms triggered in Veeam Service Provider Console] To resolve the alarm for managed companies, select the Resolve alarm in the client's portal check box.
