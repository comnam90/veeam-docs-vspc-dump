...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/update_backup_agents_offline.html"
...
If the machine hosting Veeam Service Provider Console Server component has no connection to the Internet, you can upgrade Veeam backup agents as described in [How to Deploy Veeam Backup Agents in Offline Mode](install_agents_offline.md).
