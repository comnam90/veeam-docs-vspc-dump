---
title: "Step 12. Specify Backup Repository Settings"
product: "vspc"
doc_type: "provider_admin"
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/specify_backup_repository_settings_lin.html"
last_updated: "10/23/2025"
product_version: "9.1.0.30636"
---

# Step 12. Specify Backup Repository Settings


The Backup Repository step of the wizard is available if at the [Destination](choose_backup_destination_lin.md) step you have chosen to save backup files on a Veeam backup repository.
...
1. In the Connection account fields, specify a domain, user name and password of the account that has access permissions on the backup repository.
...
[![Specify Backup Repository Settings](images/job_template_backup_repository_lin.webp)](images/job_template_backup_repository_lin.webp "Specify Backup Repository Settings")
