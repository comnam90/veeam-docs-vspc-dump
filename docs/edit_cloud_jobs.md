...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/edit_cloud_jobs.html"
last_updated: "11/14/2025"
product_version: "9.1.0.30636"
---

# Modifying Veeam Backup for Public Clouds Policies


To edit Veeam Backup for Public Clouds policies, you can access Veeam Backup for Public Clouds portal directly from Veeam Service Provider Console.
...
* Cloud Networks — select this tab to view policies protecting virtual network configurations

1. Select the necessary policy in the list.
2. At the top of the list, click Edit.

Alternatively, you can right-click the necessary policy and choose Edit.

Veeam Service Provider Console will open a Veeam Backup for Public Clouds policy edition wizard.
