...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/export_backup_agent_job_details.html"
...
Read-only User can only view job details but cannot perform export.
