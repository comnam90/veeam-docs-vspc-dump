---
title: "Step 15. Specify Advanced Job Settings"
product: "vspc"
doc_type: "provider_admin"
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/specify_advanced_job_settings_lin.html"
...
* [Local Storage](specify_storage_settings_lin.md) — if you have chosen to store backups in the local storage.
* [Shared Folder](specify_folder_settings_lin.md) — if you have chosen to store backups in a shared folder.
* [Backup Repository](specify_backup_repository_settings_lin.md) — if you have chosen to store backups on a Veeam Backup & Replication repository.
* [Cloud Repository](specify_cloud_backup_settings_lin.md) — if you have chosen to store backups on a Veeam Cloud Connect repository or an object storage repository.
...
For details on synthetic full backup, see section [Synthetic Full Backup](https://helpcenter.veeam.com/docs/agentforlinux/userguide/synthetic_full_backup.html) of the Veeam Agent for Linux User Guide.
...
For details on active full backup, see section [Active Full Backup](https://helpcenter.veeam.com/docs/agentforlinux/userguide/active_full_backup.html) of the Veeam Agent for Linux User Guide.

|  |
| --- |
| Note: |
| * Before scheduling periodic full backups, you must make sure that you have enough free space on the target location. As an alternative, you can create active full backups manually when needed. * Synthetic full backups are available for Veeam Agent for Linux version 13 or later. * If you schedule the active full backup and synthetic full backup on the same day, Veeam backup agent will perform only active full backup. Synthetic full backup will be skipped. |

[![Specify Advanced Backup Settings](images/advanced_settings_backup_lin.webp)](images/advanced_settings_backup_lin.webp "Specify Advanced Backup Settings")
...
1. To periodically perform a health check for the backup chain, in the Storage-level corruption guard section, select the Perform backup files health check check box and specify the schedule for the health check.
...
For details on a health check for the object storage repositories, see section [Health Check for Object Storage](https://helpcenter.veeam.com/docs/agentforlinux/userguide/backup_health_check.html) of the Veeam Agent for Linux User Guide.
...
[![Specify Advanced Settings](images/advanced_settings_maintenance_lin.webp)](images/advanced_settings_maintenance_lin.webp "Specify Advanced Settings")
...
For details on data compression and storage optimization, see section [Data Compression](https://helpcenter.veeam.com/docs/agentforlinux/userguide/compression_deduplication.html) of the Veeam Agent for Linux User Guide.
