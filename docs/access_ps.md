...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/access_ps.html"
...
Before you launch remote PowerShell console, make sure you have enabled PowerShell access to remote computers. For details, see [Configuring Remote Access](configure_access.md).
