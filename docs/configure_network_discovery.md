...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/configure_network_discovery.html"
...
You can select more than one company at this step. In this case, after you complete the wizard steps, Veeam Service Provider Console will create a separate discovery rule for each company. To configure a discovery rule for hosted infrastructure, select your company name in the list.
...
[![Configure Backup Agent Deployment](images/discovery_rule_vaw.webp)](images/discovery_rule_vaw.webp "Configure Backup Agent Deployment")
