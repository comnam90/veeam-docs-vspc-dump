---
title: "Step 1. Obtain ConnectWise Manage API Keys"
product: "vspc"
...
In ConnectWise Manage, generate a public and a private API keys:
...
For details, see [ConnectWise Manage Documentation](https://docs.connectwise.com/ConnectWise_Documentation/090/040/010/040).

1. Navigate to the API Keys tab and click the New Item icon.
2. In the Description field, enter a description for the API key.
3. Click the Save icon.

The Public and Private API keys will display.

1. Copy and save both API keys.
