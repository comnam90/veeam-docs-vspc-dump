...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/create_invoice_auditors.html"
...
1. At the Role step of the wizard, choose Company Invoice Auditor.
