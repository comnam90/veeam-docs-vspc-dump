---
title: "Creating Protected Computers Report"
product: "vspc"
doc_type: "provider_admin"
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/configure_computers_report.html"
last_updated: "8/13/2025"
product_version: "9.1.0.30636"
---

# Creating Protected Computers Report


To create a Protected Computers report configuration:
...
[![Specify Report Name and Description](images/backup_report_name_computer.webp)](images/backup_report_name_computer.webp "Specify Report Name and Description")
...
[![Choose Companies](images/backup_report_companies_computer.webp)](images/backup_report_companies_computer.webp "Choose Companies")
...
By choosing a location you can limit the scope of the report: only computers that belong to the chosen locations will appear in the report.

[![Choose Locations](images/backup_report_locations_computer.webp)](images/backup_report_locations_computer.webp "Choose Locations")
...
[![Select Access Type](images/backup_report_access_type_computer.webp)](images/backup_report_access_type_computer.webp "Select Access Type")

1. At the Parameters step of the wizard, specify parameters for analyzing protected computers:

1. In the RPO section, specify a period for which protected computers must have backup restore points.
...
1. In the Operation mode list, choose what type of Veeam backup agent operation modes must be analyzed in the report (All, Server, Workstation).
2. In the Management mode list, choose what computers must be analyzed in the report (All, Managed by console, Managed by backup server).
3. In the Exclusion mask (names) field, specify a mask for excluding computers from the report scope.

The mask will be evaluated against the computer names. You can use the ‘\*’ (asterisk) and ‘?’ (question mark) wildcards in the mask. The ‘\*’ (asterisk) character stands for zero or more characters. The ‘?’ (question mark) stands for a single character. For example, if you want to exclude from the report computers with the \_support suffix, you can specify a mask with the ‘\*\_support’ name query.

You can specify more than one mask in the field. Separate multiple masks with commas.

1. [For individual reports] In the Group by list, choose how analyzed data must be grouped in the report (by Backup agent or Backup policy).
2. In the Guest OS list, select guest OS for computers that must be analyzed in the report (Windows, Linux, macOS).
...
[![Specify Report Parameters](images/backup_report_parameters_computer.webp)](images/backup_report_parameters_computer.webp "Specify Report Parameters")
...
[![Specify Report Schedule](images/backup_report_schedule_computer.webp)](images/backup_report_schedule_computer.webp "Specify Report Schedule")

1. At the Summary step of the wizard, review the report configuration and click Finish.

[![Review Report Configuration](images/backup_report_review_computer.webp)](images/backup_report_review_computer.webp "Review Report Configuration")
