...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/vbr_job_guest_os.html"
...
3. In the Application-Aware Processing Options window, select VMs and containers for which you want to customize settings and click Edit.

If you customize processing options for a VM container, the customized settings will be applied to all VMs in the container. To customize processing options for a single VM, click Add, select the necessary VM from the list and click Add.
...
3. In the Guest File System Indexing Options window, select VMs and containers for which you want to customize settings and click Edit.

If you customize indexing options for a VM container, the customized settings will be applied to all VMs in the container. To customize indexing options for a single VM, click Add, select the necessary VM from the list and click Add.
