...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/configure_import_discovery_linux.html"
...
* Make sure that SSH port is opened on all computers.
...
2. At the top of the list, click New and select Linux.
...
[![Choose Company](images/discovery_rule_company_linux.webp)](images/discovery_rule_company_linux.webp "Choose Company")
...
[![Specify Linux Private Key](images/discovery_rule_credentials_linux_key.png)](images/discovery_rule_credentials_linux_key.png "Specify Linux Private Key")
...
* To filter computers by OS type, select By OS type in the list and click Edit. In the Operating System window, select the type of OS that must run on discovered computers (CentOS, Debian, Oracle Linux, Fedora, Ubuntu, OpenSUSE, SUSE Linux Enterprise Server, Red Hat Enterprise Linux, AlmaLinux, Rocky Linux, Amazon Linux). Click OK.
