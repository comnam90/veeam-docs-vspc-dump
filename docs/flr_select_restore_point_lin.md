...
source_url: "https://helpcenter.veeam.com/docs/vac/provider_admin/flr_select_restore_point_lin.html"
...
1. In the file-level restore portal, click Browse.
...
[![Select Files to Restore](images/flr_select_files_lin.webp)](images/flr_select_files_lin.webp "Select Files to Restore")
...
[![Search Files and Folders](images/flr_search_lin.webp)](images/flr_search_lin.webp "Search Files and Folders")
